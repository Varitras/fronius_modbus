...
# between the ordinary modules (the largest is under 700 lines) and the
# entity table.
LINE_LIMIT = 900
...
LINE_BUDGETS = {
    ...
    "entities.py": 1888,  # + the backup reserve, the SoC mode, the web SoC minimum (callifo #136), the capacity note
}
